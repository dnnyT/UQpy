...
optimizer1 = MinimizeOptimizer(method='l-bfgs-b', bounds=[[0.01, 5]])
krig2 = Kriging(regression_model=Constant(), correlation_model=Gaussian(),optimizer=optimizer1,
                correlation_model_parameters=[0.3], optimize=False,
                optimizations_number=100, normalize=False,
                random_state=2)
