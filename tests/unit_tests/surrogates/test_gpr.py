...
gpr = GaussianProcessRegressor(correlation_model=RBF(), optimizer=optimizer,
                               correlation_model_parameters=[0.14], optimize=False, random_state=1)
gpr.fit(samples=samples, values=values, correlation_model_parameters=[0.3])

optimizer = MinimizeOptimizer(method="L-BFGS-B")
gpr2 = GaussianProcessRegressor(correlation_model=Matern(mu=0.5), optimizer=optimizer, 
                                correlation_model_parameters=[0.3], bounds=[[0.01, 5]], optimize=False, 
